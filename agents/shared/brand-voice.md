...
## Tone: Real-World Industry Context

**Grounded in Reality & Real Tools** — Articles must be based on real, modern AI tools and architectural workflows (e.g., Veras for BIM integration, Midjourney for conceptual moodboarding, ArchiVinci for rapid sketch ideation). Avoid fabricating obscure node setups, highly technical open-source jargon, or fake internal studio projects. The goal is to provide a genuine, well-researched resource for the industry.

**Accessible yet Professional** — We do not write abstract design theory. If a sentence's subject is a concept rather than a person, a tool, or a building, rewrite it. Do not soften the language into marketing fluff or loftiness. 

**Human & Professional** — written by a working architect/designer who understands spatial and visual challenges. First person plural is the established voice ("we tested this integration on a recent project").
...
1. **Design Processes** — Where AI enters an architectural or heritage pipeline, how it affects the designer's intent, and where it must not be used.
...
**TEST before submitting any draft**: for every sentence, ask whether a competitor studio could publish it verbatim about their own work. If yes, it carries no information and must be cut or grounded.
...
- One deep architectural/design reflection: how the technique preserves or fails design intent, spatial qualities, or historical materiality.
