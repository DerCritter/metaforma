...
export const Hero: React.FC<HeroProps> = ({ onExplore, isDark = false, language }) => {
  ...
  return (
    ...
    >
      <div className={`absolute inset-0 z-0 ${isDark ? 'opacity-[0.95]' : 'opacity-85'} bg-black`}>
        ...
        <div className={`absolute inset-0 ${isDark ? 'bg-[#030303]/20' : 'bg-white/0'} backdrop-blur-[0.5px] pointer-events-none`}></div>
      </div>
