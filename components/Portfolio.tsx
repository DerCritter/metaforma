...
export const getArchitectureProjects = (language: Language): Project[] => {
  ...
  const tp = translations[language].tags;
  return [
    {
      id: 'arch-03',
      category: 'architecture',
      title: ts.project_coworking,
      description: ts.project_coworking_desc,
      ...
      tags: [tp.workplace, tp.adaptive_reuse, tp.modernist],
      location: 'Wuppertal'
    },
    {
      id: 'arch-01',
      category: 'architecture',
      title: ts.project_lofts,
      description: ts.project_lofts_desc,
      ...
      tags: [tp.industrial_heritage, tp.luxus_lofts, tp.adaptive_reuse],
      location: 'Nürnberg'
    },
    {
      id: 'arch-02',
      category: 'architecture',
      title: ts.project_multifamily,
      description: ts.project_multifamily_desc,
      ...
      tags: [tp.heritage, tp.multi_family, tp.residential],
      location: 'Wuppertal'
    },
    {
      id: 'arch-04',
      category: 'architecture',
      title: ts.project_apartment,
      description: ts.project_apartment_desc,
      ...
      tags: [tp.commercial, tp.modern_neubau, tp.glass_architecture],
      location: 'Baden-Württemberg'
    },
    {
      id: 'arch-07',
      category: 'architecture',
      title: ts.project_penthouse,
      description: ts.project_penthouse_desc,
      ...
      tags: [tp.office, tp.digital_synthesis, tp.industrial],
      location: 'NRW'
    }
  ];
};
...
export const Portfolio: React.FC<PortfolioProps> = ({ category, onSelectProject, isDark, language }) => {
  const [viewMode, setViewMode] = React.useState<'cards' | 'cloud'>('cards');
  const t = translations[language].portfolio_ui;
  const projectList = getArchitectureProjects(language);

  // Flatten all images for the cloud view
  const allProjectImages = projectList.flatMap(p =>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-24 lg:mb-32 gap-6 md:gap-10">
        <div className="space-y-3 md:space-y-4 lg:space-y-6">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-heading font-light tracking-tighter leading-[1] md:leading-[0.9]">
            ...
            <span className={`italic ${isDark ? 'text-white' : 'text-black'}`}>{t.portfolio_title2}</span>
          </h2>
        </div>
