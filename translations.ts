...
export const translations: Record<Language, LanguageDictionary> = {
  en: {
    ...
    services: {
      ...
      pillar3_label: 'PILLAR III: GROWTH',
      ...
      growth_desc: 'We provide the technical framework to showcase your heritage projects on any platform with maximum engagement.',
    ...
    contact_form: {
      ...
      description: 'Based in Berlin, Germany. Serving visionary real estate leaders globally with AI-native architecture and heritage transformation.',
      hq_label: 'HQ BERLIN',
